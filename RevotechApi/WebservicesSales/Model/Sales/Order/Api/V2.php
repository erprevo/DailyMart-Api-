<?php
class RevotechApi_WebservicesSales_Model_Sales_Order_Api_V2 extends Mage_Sales_Model_Order_Api_V2
{
    public function items($filters = null)
    {
        ...
        $billingFirstnameField = "$billingAliasName.lastname";
        $billingLastnameField = "$billingAliasName.lastname";
        $shippingFirstnameField = "$shippingAliasName.lastname";
